...
**Задача 7:** Имаме n акционери и масив A[1..n], където A[k] = броят акции, притежавани от k-тия акционер. Да се състави бърз алгоритъм за закупуване на контролен пакет акции (т.е. повече от половината) чрез преговори **с възможно най- малко акционери**. Алгоритъмът да връща този минимален брой акционери.  
