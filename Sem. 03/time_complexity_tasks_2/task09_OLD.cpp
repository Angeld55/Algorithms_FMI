...
// Решението, което направихме в час работи за модифицирания пример (task9.cpp)

// Скица на правилното решение на задачата:
//Задачата се решава малко по-сложно. Игнорирайки мултипликативните константи (10 и 11) ще получим формулата за броят пътищя в grid-граф от (0,0) до (i,j).
